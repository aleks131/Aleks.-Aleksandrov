...
import { FaCode, FaChartLine, FaProjectDiagram, FaLaptopCode, FaEnvelope, FaArrowRight, FaLinkedin, FaJava, FaDatabase, FaChartBar, FaFileAlt } from "react-icons/fa";
        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          >
            <div className="relative flex justify-center mb-12">
              ...
              <motion.div
                className="relative w-72 md:w-80 z-10"
          ...
          >
            ...
            >
              ...
              <div className="flex gap-4 items-center flex-wrap">
                {[
                  { href: "https://www.linkedin.com/in/aleks-aleksandrov-42a472238/", icon: <FaLinkedin size={24} />, color: "bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-600", label: "LinkedIn" },
                  { href: "#contact", icon: <FaEnvelope size={24} />, color: "bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 hover:bg-green-600 hover:text-white dark:hover:bg-green-600", label: "Contact" },
                  { href: "/images/about/Aleksreclet.pdf", icon: <FaFileAlt size={24} />, color: "bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 hover:bg-purple-600 hover:text-white dark:hover:bg-purple-600", label: "Rec Letter 1" },
                  { href: "/images/about/Aleksreclet2.pdf", icon: <FaFileAlt size={24} />, color: "bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-600", label: "Rec Letter 2" },
                ].map((link, i) => (
                  <motion.a
                    key={i}
                    href={link.href}
